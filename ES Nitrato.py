...
#Dados Nitrato
dn = pd.read_csv("Dinâmica Nitrato.csv", decimal=",")

for series_name, series in dn.items():
...
dtn = pd.read_csv("Dados de Treinamento Nitrato.csv", decimal=",")

for series_name, series in dtn.items():
    if series_name == "Medição": continue
...
#Dados de Validação
dvn = pd.read_csv("Dados de Validação Nitrato.csv", decimal=",")

for series_name, series in dvn.items():
    if series_name == "Medição": continue

...
#Dados Sulfato
dsa = pd.read_csv("./data/ESSulfato.csv", decimal=",")
dtsa = pd.read_csv("./data/ESSulfato_Treinamento.csv", decimal=",")
dvsa = pd.read_csv("./data/ESSulfato_Validacao.csv", decimal=",")
...
calculateTudo(dsa)
calculateTudo(dtsa, 'Treinamento')
calculateTudo(dvsa, 'Validação')

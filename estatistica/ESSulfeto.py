...
#Dados Sulfeto
dse = pd.read_csv("./data/ESSulfeto.csv", decimal=",")
dtse = pd.read_csv("./data/ESSulfeto_Treinamento.csv", decimal=",")
dvse = pd.read_csv("./data/ESSulfeto_Validacao.csv", decimal=",")
...
calculateTudo(dse)
calculateTudo(dtse, 'Treinamento')
calculateTudo(dvse, 'Validação')
